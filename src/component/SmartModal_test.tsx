...
export const Modal_test: React.FC<SmartModalProps> = ({
  isOpen,
  onClose,
  triggerTop,
  title = "系統訊息",
  ...
  return (
    <div className="      fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
      <div className={`  flex flex-col bg-white rounded-lg shadow-lg  w-40  `}>
        {/* Header */}
...
export default SmartModal_test;